...
"string"!==typeof a.nodeName?!1:!0}else b=!1;if(!b)throw TypeError("element must be a DOM node, got "+a);}function i(a,b,c,n){function h(){e.addEventListener("webkitTransitionEnd",f,!1);e.addEventListener("transitionend",f,!1);e.addEventListener("oTransitionEnd",f,!1);e.addEventListener("otransitionend",f,!1);e.addEventListener("MSTransitionEnd",f,!1);e.addEventListener("transitionend",f,!1)}function f(){w||(w=!0,e.removeEventListener("webkitTransitionEnd",f),e.removeEventListener("transitionend",
f),e.removeEventListener("oTransitionEnd",f),e.removeEventListener("otransitionend",f),e.removeEventListener("MSTransitionEnd",f),e.removeEventListener("transitionend",f),r(a),o(a,""),o(b,""),setTimeout(function(){k(a,"");k(b,"");d[0].fade&&(b.style.opacity=l.opacity);d[1].fade&&(a.style.opacity=z.opacity);b.style.position=l.position;b.style.top=l.top;b.style.left=l.left;b.style.height=l.height;b.style.width=l.width;a._swapper=!1;b._swapper=!1;n()},0))}v(a);v(b);"function"===typeof c&&(n=c,c={});
...
g;if(a._swapper)throw Error("elem1 is currently being swapped");if(b._swapper)throw Error("elem2 is currently being swapped");a:{for(g=a;g=g.parentNode;)if(g===t){g=!0;break a}g=!1}if(!g)throw Error("elem1 must be in the DOM to be swapped");a._swapper=!0;b._swapper=!0;r(b);if("instant"===c.transition)u(b,a),r(a),a._swapper=!1,b._swapper=!1,setTimeout(function(){n()},0);else{var d=x[c.transition||"fade"],j=y[c.easing||"ease-in-out"],i=c.duration||300;u(b,a);var c=a.getBoundingClientRect(),q=p(a),s=
p(b),z=p(a,!0),l=p(b,!0);"none"!==q.display&&(b.style.position="fixed",b.style.top=c.top+"px",b.style.left=c.left+"px");b.style.height=s.height||q.height;b.style.width=s.width||q.width;d[2]&&a.parentNode.insertBefore(b,a);k(a,m);k(b,d[0].transform||m);d[0].fade&&(b.style.opacity="0");d[1].fade&&(a.style.opacity="1");setTimeout(function(){var c="transform "+i/1E3+"s "+j+", opacity "+i/1E3+"s "+j;o(a,c);o(b,c);setTimeout(function(){k(a,d[1].transform||m);k(b,m);if(d[0].fade)b.style.opacity="1";if(d[1].fade)a.style.opacity=
"0";if(s.display!=="none"&&(d[0].fade||d[0].transform&&d[0].transform!==m)){e=b;h()}else if(q.display!=="none"&&(d[1].fade||d[1].transform&&d[1].transform!==m)){e=a;h()}else setTimeout(f,i)},0)},0);var w=!1,e}}var m="translate3d(0,0,0) scale(1)";/\bandroid\b/i.test(navigator.userAgent);var x={fade:[{fade:!0},{fade:!0}],"fade-on":[{fade:!0},{}],"fade-off":[{},{fade:!0},!0],"scale-in":[{transform:"scale(0.01)"},{}],"scale-out":[{},{transform:"scale(0.01)"},!0],"rotate-left":[{transform:"rotateY(-180deg) perspective(360px)",
